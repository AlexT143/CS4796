...
def train_and_save_model(epochs, batch_size):
    ...
    decoder.compile(optimizer=tf.keras.optimizers.legacy.Adam(), loss="mse")
    decoder.summary()
    ...
    print(f"Test Loss for decoder: {test_loss}")

    # Save the model
    model_dir = "models/decoder"
    os.makedirs(model_dir, exist_ok=True)
    tf.keras.models.save_model(decoder, f"{model_dir}/model")
